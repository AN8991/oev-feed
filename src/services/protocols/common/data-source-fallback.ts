...
/**
 * Service for handling fallback between different data sources (on-chain, subgraph, API)
 */
export class DataSourceFallbackService {
   ...
   * @param protocolKey Unique identifier for the protocol
   ...
   * @param protocolKey Unique identifier for the protocol
   * @param operations Map of operations for each data source type
